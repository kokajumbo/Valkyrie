...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ПараметрыЗаписи.Вставить("ИспользоватьЗаявкиНаКредитПередЗаписью",
		ПолучитьФункциональнуюОпцию("ИспользоватьЗаявкиНаКредит"));
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ПараметрыЗаписи.Вставить("ИспользоватьЗаявкиНаКредитПослеЗаписи",
		ПолучитьФункциональнуюОпцию("ИспользоватьЗаявкиНаКредит"));
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Перем ИспользоватьЗаявкиНаКредитПередЗаписью, ИспользоватьЗаявкиНаКредитПослеЗаписи;
	...
	Если ПараметрыЗаписи.Свойство("ИспользоватьЗаявкиНаКредитПередЗаписью", ИспользоватьЗаявкиНаКредитПередЗаписью)
		И ПараметрыЗаписи.Свойство("ИспользоватьЗаявкиНаКредитПослеЗаписи", ИспользоватьЗаявкиНаКредитПослеЗаписи) Тогда
		
		Если ИспользоватьЗаявкиНаКредитПередЗаписью <> ИспользоватьЗаявкиНаКредитПослеЗаписи Тогда
			ОбновитьИнтерфейс = Истина;
		КонецЕслИ;
...
Процедура УправлениеФормой(Форма)
	...
	ГруппаФССВидимость = НЕ Форма.ЭтоФизЛицо ИЛИ Форма.ИПИспользуетТрудНаемныхРаботников ИЛИ Форма.УплачиватьДобровольныеВзносыВФСС;
