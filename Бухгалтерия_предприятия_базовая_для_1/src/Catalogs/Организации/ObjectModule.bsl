...
Процедура ПередЗаписью(Отказ)
	...
	Если Обработки.ФункциональностьПрограммы.ДоступнаФункциональностьУчетПоНесколькимОрганизациям()
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru = 'Возможность ведения учета по нескольким организациям отключена. Чтобы добавить новую организацию, включите флаг ""Учет по нескольким организациям"" в настройках Функциональности (Главное - Функциональность - вкладка Организация).'")
				,
				,
				,
				,
...
Процедура ПриЗаписи(Отказ)
	...
	Если НЕ Отказ
		...
		И НЕ ПолучитьФункциональнуюОпцию("ИспользоватьСервисРегистрации")
	...
	ЗаявкиНаКредит.ПриЗаписиОрганизации(Ссылка);
