...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ЗаголовокУполномоченноеЛицоПредставителя.Доступность = ПредставительЮрЛицо;
	Элементы.УполномоченноеЛицоПредставителя.Доступность = ПредставительЮрЛицо;
	
	СкрытьДоверенностьЭДО = Неопределено;
	Если Форма.Параметры.Свойство("СкрытьДоверенностьЭДО", СкрытьДоверенностьЭДО) Тогда
		Форма.Элементы.ЗаголовокДоверенностьЭДО.Видимость = Не СкрытьДоверенностьЭДО;
		Форма.Элементы.Доверенность.Видимость = Не СкрытьДоверенностьЭДО;
	КонецЕсли;
