...
//
// Параметры:
//   Карты - Массив, ФиксированныйМассив - карты, номера которых нужно получить.
//      * СправочникСсылка.БанковскиеКартыКонтрагентов
//
// Возвращаемое значение:
//  Соответствие - Ключ - ссылка на карту, Значение - маскированный номер карты.
...
//
// Возвращаемое значение:
//  Соответствие - Ключ - ссылка на карту, Значение - полный номер карты.
//      * Ключ     - СправочникСсылка.БанковскиеКартыКонтрагентов, 
//      * Значение - Строка.
//
