...
//
// Параметры:
//  Форма        - УправляемаяФорма - на которой производятся настройки элементов.
...
// Вызывается из обработчика ПриАктивизацииОбласти() поля табличного документа.
//
// Параметры:
//  ТабличныйДокумент      - ТабличныйДокумент - документ, в котором выделены ячейки.
...
//
Процедура НачатьРасчетСуммыВыделенныхЯчеек(ТабличныйДокумент, Форма, ИмяОбработчикаОжидания) Экспорт
...
//
Функция ВычислитьСуммуВыделенныхЯчеекТабличногоДокумента(ПолеСумма, Результат, КэшВыделеннойОбласти, НеобходимоВычислятьНаСервере = Неопределено) Экспорт
