	...
	Для Каждого Регистратор Из Регистраторы Цикл
		...
		Представление = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(РеквизитыРегистратора[Регистратор].Номер, Истина, Ложь),
...
Функция ПредставлениеОплаты(СписокОплат)  
	...
	Возврат ВедомостьНаВыплатуЗарплатыФормыБазовый.ПредставлениеОплаты(СписокОплат);
