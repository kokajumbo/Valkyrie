...
Функция СпособВыполненияЗадачи(Правило) Экспорт
	...
	ИначеЕсли (ИдентификаторЗадачи = "ТранспортныйНалог"
		...
		Возврат "УплатаАвансовЗемельныйТранспортныйНалог"; // по данным государственного учета имущества
...
Функция СтатусыЗадачПоУплатеНалогов(ТаблицаЗадач)
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли ПравилоВыполняетсяПомощникомЗаполнения3НДФЛ(Выборка) Тогда
