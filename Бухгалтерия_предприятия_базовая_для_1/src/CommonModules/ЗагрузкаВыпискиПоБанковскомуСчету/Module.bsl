				...
				Если Операция[ИмяПротивоположнойСтороны + "Идентификаторы"].Количество() Тогда
					...
					Если ИспользуетсяБанкДляРасчетов Тогда
						...
						Если НомерСчетаПротивоположнойСтороныСоответствуетБИК Тогда
							...
							Если Не БанковскиеПравила.ЭтоКорсчетБанкаНерезидента(РеквизитыПротивоположнойСтороны.РасчСчет) Тогда
...
Функция СоставныеЧастиНазванияБанка()
	...
	ТочноеСоответствие.Вставить("ФКБ",  Истина); // Филиал комерческого банка
	ТочноеСоответствие.Вставить("ФАКБ", Истина); // Филиал акционерного комерческого банка
	ТочноеСоответствие.Вставить("КБ",   Истина); // Комерческий банк
	ТочноеСоответствие.Вставить("КИБ",  Истина); // Комерческий инвестиционный банк
...
Функция ВыплатаЗаработнойПлатыПоРеестру(Операция)
	...
	Возврат БанковскиеПравила.ЭтоОбязательстваПоПрочимОперациям(Операция.БалансовыйСчет)
