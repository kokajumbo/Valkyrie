...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения51_Краткосрочная(КонтекстВыполнения)
	...
	УстановитьПолныйТекстЗапроса(Запрос, ТекстЗапросаПояснения51_Краткосрочная(), "СФПолученные");
	Запрос.Выполнить();
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5554и5574(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПрочие = "60.01, 60.21, 60.31, 60.03, 62.02, 62.22, 62.32, 62.ОТ, 76.05, 76.25, 76.35, 76.06, 76.26, 76.36, 76.09, 76.29, 76.39, 76.07.2, 76.27.2, 76.37.2, 76.07.1, 76.27.1, 76.37.1";
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5560и5580(КонтекстВыполнения, НомерСтроки)
	...
	СчетаАвансов  = "62.02, 62.22, 62.32, 62.ОТ";
	СчетаНДСАвансов = "76.АВ";
	СчетаРасчетовПоНалогам = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.32, 68.42,
	...
	СчетаШтрафыПени = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.32, 68.42,
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5562и5582(КонтекстВыполнения, НомерСтроки)
	...
	СчетаАвансов  = "62.02, 62.22, 62.32, 62.ОТ, 76.06, 76.26, 76.36";
	СчетаНДСАвансов = "76.АВ";
	СчетаПеревода = "76.06, 76.26, 76.36";
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения53_Краткосрочная(КонтекстВыполнения)
	...
	УстановитьПолныйТекстЗапроса(Запрос, ТекстЗапросаПояснения53_Краткосрочная(), "СФВыданные");
	Запрос.Выполнить();
...
Процедура УстановитьПолныйТекстЗапроса(ИсходныйЗапрос, ИсходныйТекстЗапроса, ВидСчетовФактур)
