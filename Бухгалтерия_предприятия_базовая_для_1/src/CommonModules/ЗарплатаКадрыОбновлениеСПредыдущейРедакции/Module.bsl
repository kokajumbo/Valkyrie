...
Процедура ЗарплатаКадрыОбновлениеС20()Экспорт
	...
	УчетСтажаПФРБазовый.ЗаполнитьПервоначальныеДанныеУчета();
	...
	Документы.ВедомостьНаВыплатуЗарплатыВКассу.ЗаполнитьПериодыВзаиморасчетовЗарплаты();
	Документы.ВедомостьНаВыплатуЗарплатыВБанк.ЗаполнитьПериодыВзаиморасчетовЗарплаты();
	Документы.ВедомостьНаВыплатуЗарплатыВКассу.ЗаполнитьФизическиеЛицаЗарплаты();
	Документы.ВедомостьНаВыплатуЗарплатыВБанк.ЗаполнитьФизическиеЛицаЗарплаты();
	
	ВедомостьНаВыплатуЗарплаты.ЗаполнитьСоставВедомости("Документ.ВедомостьНаВыплатуЗарплатыВБанк", "ФизическоеЛицо, НомерЛицевогоСчета");
	ВедомостьНаВыплатуЗарплаты.ЗаполнитьСоставВедомости("Документ.ВедомостьНаВыплатуЗарплатыВКассу", "ФизическоеЛицо");
...
Процедура ЛицевыеСчетаСотрудниковКонвертация(СоответствиеКонвертированныхОбъектов)
	...
	ЗаполнитьБанкПоКлассификатору();
	
КонецПроцедуры

Процедура ЗаполнитьБанкПоКлассификатору()
