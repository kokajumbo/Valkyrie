...
Функция МакетКомпоновкиДанныхОтчета(ОтчетОбъект, КлючВарианта, ПодготовитьМакетЕслиНеНайден = Истина) Экспорт
	...
	Иначе
		ЗагрузитьНастройкиПечатнойФрмы(ОтчетОбъект.КомпоновщикНастроек, НастройкиПечатнойФормы(Отчет, КлючВарианта));
	КонецЕсли;
...
Функция ДобавитьМакетКомпоновкиДанныхОтчета(Отчет, ИмяОтчета, КлючВарианта, ОтчетОбъект = Неопределено)
	...
	Если НастройкиПечатнойФормы <> Неопределено Тогда
		...
		ЗагрузитьНастройкиПечатнойФрмы(ОтчетОбъект.КомпоновщикНастроек, НастройкиПечатнойФормы);
	Иначе
...
Процедура ЗагрузитьНастройкиПечатнойФрмы(КомпоновщикНастроекКД, НастройкиПечатнойФормы) Экспорт
