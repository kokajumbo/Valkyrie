...
Функция КодыРегионовЭксплуатации() Экспорт
	...
	КодыРегионов.Добавить(18); // Удмуртская Республика
	КодыРегионов.Добавить(30); // Астраханская область	
	КодыРегионов.Добавить(40); // Калужская область	
	КодыРегионов.Добавить(42); // Кемеровская область	
	КодыРегионов.Добавить(48); // Липецкая область
	КодыРегионов.Добавить(56); // Оренбургская область
	КодыРегионов.Добавить(58); // Пензенская область
	КодыРегионов.Добавить(62); // Рязанская область
	КодыРегионов.Добавить(69); // Тверская область
	КодыРегионов.Добавить(71); // Тульская область
	КодыРегионов.Добавить(76); // Ярославская область
