...
Процедура ЗагрузитьФизическиеЛица(ОбъектXDTO, УзелОбмена) Экспорт
	...
	Если ЗначениеЗаполнено(Объект.Имя) Тогда
		Объект.ИнициалыИмени     = ФизическиеЛицаЗарплатаКадрыКлиентСервер.ИнициалыИмени(Объект.Имя);
	КонецЕсли;
...
Процедура ЗагрузитьФИОФизическихЛиц(ОбъектXDTO, УзелОбмена) Экспорт
	...
	Если ЗначениеЗаполнено(ОбъектXDTO.Имя) Тогда
		НоваяЗапись.ИнициалыИмени    = ФизическиеЛицаЗарплатаКадрыКлиентСервер.ИнициалыИмени(ОбъектXDTO.Имя);
	Иначе
		НоваяЗапись.ИнициалыИмени    = "";
	КонецЕсли;
