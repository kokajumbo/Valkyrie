...
Функция ИдентификаторЭтогоУзлаДляОбмена(УзелОбмена) Экспорт
	...
	ИспользоватьПрефикс = Неопределено;
	...
	ИначеЕсли Не ОбщегоНазначения.РазделениеВключено()
		И Не ЭтоПланОбменаXDTO(ИмяПланаОбмена) Тогда
	...
	Если ОбменДаннымиПовтИсп.ЭтоУзелРазделенногоОбменаДаннымиБСП(УзелОбмена)
		И ИспользоватьПрефикс <> Ложь Тогда
