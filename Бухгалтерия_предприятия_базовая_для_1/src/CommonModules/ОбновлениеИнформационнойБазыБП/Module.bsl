...
#КонецОбласти
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.67.14";
	Обработчик.Процедура           = "УчетОбособленныхПодразделений.ЗаполнитьГраницыКонтролируемости";
	Обработчик.НачальноеЗаполнение = Истина; // В противном случае процедура не запустится при переход
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.72.36";
	Обработчик.Процедура           = "РегистрыСведений.СтавкиТранспортногоНалога.ЗаполнитьСтавки";
	Обработчик.НачальноеЗаполнение = Истина; // Процедура должна запускаться при переходе с 2БП на 3БП
	Обработчик.ОбщиеДанные         = Истина;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.73.44";
	Обработчик.Процедура           = "ЗаявкиНаКредит.УстановитьКонстантуИспользоватьЗаявкиНаКредит";
	Обработчик.НачальноеЗаполнение  = Ложь;
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	Константы.ДатаТекущейВерсии.Установить(Дата(2019,09,26));
