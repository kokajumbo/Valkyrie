...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если ПараметрыРаботыКлиента.Свойство("ОшибкаПроверкиАктивации") Тогда
		
		Параметры.ИнтерактивнаяОбработка = Новый ОписаниеОповещения("ПоказатьОшибкуАктивации", ЭтотОбъект);
		Возврат;
	КонецЕсли;
...
Процедура ПоказатьОшибкуАктивации(Параметры, ДополнительныеПараметры) Экспорт
	
	Оповещение = Новый ОписаниеОповещения("ПродолжитьВыполнение", ОбщегоНазначенияБПКлиент, Параметры);
	
	ПараметрыРаботыКлиента = СтандартныеПодсистемыКлиентПовтИсп.ПараметрыРаботыКлиентаПриЗапуске();
	ПараметрыФормы = Новый Структура();
	ПараметрыФормы.Вставить("ОшибкаПроверкиАктивации", ПараметрыРаботыКлиента.ОшибкаПроверкиАктивации);
	
	Если ПараметрыРаботыКлиента.ОшибкаПроверкиАктивации = "НетРегистрационныхДанных" Тогда
		ПараметрыФормы.Вставить("АктивацияОрганизации", Истина);
		ОткрытьФорму("Обработка.НачалоРаботы.Форма.АктивацияПрограммы", ПараметрыФормы, , , , , Оповещение, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	Иначе
		ОткрытьФорму("Обработка.НачалоРаботы.Форма.СведенияОЛицензии", ПараметрыФормы, , , , , Оповещение, РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	КонецЕсли;
