...
// 
// Параметры:
// 	Форма - УправляемаяФорма - форма проверки и подбора с данными проверяемой маркируемой продукции.
//
...
Процедура ОпределитьТипУпаковкиПриИзмененииСтроки(Форма, ИдентификаторИзмененойСтроки) Экспорт

	ИзмененнаяСтрока = Форма.ДеревоМаркированнойПродукции.НайтиПоИдентификатору(ИдентификаторИзмененойСтроки);
...
Процедура ОпределитьТипУпаковки(Форма, СтрокаДерева, ВключаяПодчиненные)
	...
	ПроверкаИПодборПродукцииИСКлиентСервер.УстановитьЗначениеДляУпаковки(СтрокаДерева,
		...
		Серии, ВУпаковкеРазныеСерии);
	
	ПроверкаИПодборПродукцииИСКлиентСервер.УстановитьЗначениеДляУпаковки(СтрокаДерева,
		"Справка2", "ВУпаковкеРазныеСправки2",
		Справки2, ВУпаковкеРазныеСправки2);
