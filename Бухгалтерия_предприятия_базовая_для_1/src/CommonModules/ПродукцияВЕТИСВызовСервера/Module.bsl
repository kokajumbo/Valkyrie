...
// 
// Параметры:
// 	ЗаписьСкладскогоЖурналя - СправочникСсылка.ЗаписиСкладскогоЖурналаВЕТИС - проверяемая запись
// Возвращаемое значение:
// 	Булево - Возвращает истину, если запись складского журнала содержит продукцию четвертого уровня
//
&НаСервере
Функция ЗаписьЖурналаСодержитПродукциюЧетвертогоУровня(ЗаписьСкладскогоЖурналя) Экспорт
	...
	Запрос.УстановитьПараметр("Ссылка", ЗаписьСкладскогоЖурналя);
...
//   * ЗаписьСкладскогоЖурнала - СправочникСсылка.ЗаписиСкладскогоЖурналаВЕТИС - Запись складского журналя из ТЧ
