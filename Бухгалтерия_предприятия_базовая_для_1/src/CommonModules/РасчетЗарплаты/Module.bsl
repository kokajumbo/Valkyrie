...
// 
Функция РекомендуемыеКорректировкиВыплаты(Налоги, ТекущиеКорректировкиВыплаты, ГодНалоговогоПериода = НеОпределено) Экспорт
	...
	Для Каждого СтрокаНалога Из Налоги Цикл
		...
		Если СтрокаНалога.НалоговыйПериод = ГодНалоговогоПериода Тогда
