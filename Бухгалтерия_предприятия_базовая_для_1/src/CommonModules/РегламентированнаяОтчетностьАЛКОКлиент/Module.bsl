...
Процедура КомандаОчиститьРегистрыОтМусораАЛКО(Форма)
	...
	ТекстПредупреждение = Новый ФорматированнаяСтрока(НСтр("ru='После применения данной процедуры восстановление удаленных страниц станет невозможным!'"), ЖирныйНаклонныйШрифт);
	ТекстПредупреждение2 = Новый ФорматированнаяСтрока(НСтр("ru='Если Отчет изменен, перед очисткой изменения будут сохранены!'"), ЖирныйНаклонныйШрифт);
