...
Функция ПоказателиДекларацииНДС(Организация, ГруппаОрганизаций, НачалоПериода, КонецПериода) Экспорт
...
Процедура РассчитатьПоказателиРаздела3Декларации2019Кв1(СтруктураПоказателей)
	...
	СтруктураПоказателей.П000300004105 = Окр(СтруктураПоказателей.П000300004005);
	СтруктураПоказателей.П000300004205 = Окр(СтруктураПоказателей.П000300004005);
