...
// Выполняет регистрацию в учете начисленной зарплаты резултатов перерасчета НДФЛ.
// 	Параметры:
...
//	ПериодРегистрации - Дата - определяет период получения данны.
//	Организация - СправочникСсылка.Организации - Организация.
//	ОкончательныйРасчет - Булево.
//	Авансом - признак того, что требуется получить данные для первой половины месяца.
//
