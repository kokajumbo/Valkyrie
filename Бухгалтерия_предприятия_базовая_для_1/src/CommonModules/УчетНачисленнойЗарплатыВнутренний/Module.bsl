...
// См. УчетНачисленнойЗарплаты.ЗарегистрироватьПерерасчетНДФЛ
Процедура ЗарегистрироватьПерерасчетНДФЛ(ДанныеДляПроведения, Отказ, НДФЛ, КорректировкиВыплаты, ЗаписыватьДвижения) Экспорт

	УчетНачисленнойЗарплатыБазовый.ЗарегистрироватьПерерасчетНДФЛ(ДанныеДляПроведения, Отказ, НДФЛ, КорректировкиВыплаты, ЗаписыватьДвижения);
