...
Функция АктуальныеВидыЭД() Экспорт
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		СоответствиеЭДОбменСКонтрагентами = МодульОбменСКонтрагентамиПовтИсп.ПолучитьАктуальныеВидыЭД();
		МассивЭДОбменСКонтрагентами = Новый Массив;
		Для каждого КлючИЗначение Из СоответствиеЭДОбменСКонтрагентами Цикл
			МассивЭДОбменСКонтрагентами.Добавить(КлючИЗначение.Ключ);
		КонецЦикла; 
