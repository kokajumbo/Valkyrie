...
Функция СформироватьПечатнуюФорму(МассивОбъектов, ПараметрыПечати, ОбъектыПечати)
	...
	ИначеЕсли МенеджерОборудованияВызовСервера.ПолучитьОписаниеМакета(XMLОписаниеМакета, СообщениеОбОшибке, СодержимоеXMLФайла) Тогда
		...
		ДанныеЭтикеток = ДанныеДляПечатиЭтикеток(ТаблицаНоменклатуры, ПараметрыПечати.АдресХранилищаСКД, XMLОписаниеМакета, ПараметрыПечати.ТипЦен);
...
Функция ДанныеДляПечатиЭтикеток(СписокНоменклатуры, АдресХранилищаСКД, Знач XMLОписаниеМакета, ТипЦен) Экспорт
