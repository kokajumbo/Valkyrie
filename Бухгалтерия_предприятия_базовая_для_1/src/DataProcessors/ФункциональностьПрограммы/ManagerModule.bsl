...
Процедура ЗаполнитьОписаниеРазделаТорговля(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ВедетсяУчетИмпортаТоваров");
	ДобавитьРодителя(Функциональность, "ИспользоватьДокументыПоступления");
...
Функция ОтказСнятьВедетсяУчетИмпортаТоваров()
	...
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ЗаявлениеОВвозеТоваров");

	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ПодтверждениеОплатыНДСВБюджет");
...
#Область ВедетсяУчетИмпортаТоваров

Функция ТаблицаЗапросовВедетсяУчетИмпортаТоваров()
	...
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ИмяДокумента = "ЗаявлениеОВвозеТоваров";
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ЗаявлениеОВвозеТоваров", Ложь, Ложь);

	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ИмяДокумента = "ПодтверждениеОплатыНДСВБюджет";
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ПодтверждениеОплатыНДСВБюджет", Ложь, Ложь);
	
	Возврат ТаблицаЗапросов;
	
КонецФункции 

Функция ДокументыПрепятствующиеОтключениюВедетсяУчетИмпортаТоваров()
	
	ТаблицаРезультатовЗапросов = ПустаяТаблицаДокументовПрепятствующиеОтключениюОпции();
	
	ТаблицаЗапросов = ТаблицаЗапросовВедетсяУчетИмпортаТоваров();
...
Процедура СформироватьСписокДокументовПрепятствующихОтключениюОпции(Параметры, АдресХранилища) Экспорт
	...
	ИначеЕсли Параметры.Свойство("ВедетсяУчетИмпортаТоваров") Тогда
		ТаблицаРезультатовЗапросов = ДокументыПрепятствующиеОтключениюВедетсяУчетИмпортаТоваров();
		ОбластьШапка.Параметры.Заголовок = НСтр("ru = 'Импорт товаров, в том числе из ЕАЭС'");
