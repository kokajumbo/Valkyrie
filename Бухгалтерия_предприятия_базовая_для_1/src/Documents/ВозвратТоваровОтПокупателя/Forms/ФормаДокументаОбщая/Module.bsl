...
Функция ДокументОтгрузкиСодержитНДС(ДокументОтгрузки)
	Если ЗначениеЗаполнено(ДокументОтгрузки) 
		И ОбщегоНазначения.ЕстьРеквизитОбъекта("ДокументБезНДС", ДокументОтгрузки.Метаданные()) Тогда
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаНДС.Видимость = Форма.ЕстьПравоРедактированияСчетаФактуры 
