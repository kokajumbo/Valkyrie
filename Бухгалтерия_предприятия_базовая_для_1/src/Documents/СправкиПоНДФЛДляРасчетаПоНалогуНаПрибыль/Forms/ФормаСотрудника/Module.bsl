...
Процедура УстановитьПредставлениеАдресов(Форма)
		...
		Если Не ПустаяСтрока(Форма.Объект.Адрес) Тогда
			...
			Форма.АдресПредставление = УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформации(СтруктураАдреса);
		Иначе
		...
		Если Не ПустаяСтрока(Форма.Объект.АдресЗарубежом) Тогда
			...
			Форма.АдресЗарубежомПредставление = УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформации(СтруктураАдреса);
		Иначе
