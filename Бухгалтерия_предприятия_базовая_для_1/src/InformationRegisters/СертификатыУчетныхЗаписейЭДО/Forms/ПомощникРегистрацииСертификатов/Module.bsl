...
Процедура ПодписатьИОтправитьПовторно(Команда)
	...
	Если ЗначениеЗаполнено(НеподписанныеДокументы) Тогда
		...
		Оповещение = Новый ОписаниеОповещения("СформироватьПодписатьОтправитьЭДЗавершить", ОбменСКонтрагентамиСлужебныйКлиент);
...
Процедура ОбновитьПанельДополнительнойИнформации();
	...
	Если ТекущиеДанные.Статус = 0 Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДобавитьСертификатВводДанных", "Доступность", Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДобавитьСертификатВводДанных", "КнопкаПоУмолчанию", Истина);
