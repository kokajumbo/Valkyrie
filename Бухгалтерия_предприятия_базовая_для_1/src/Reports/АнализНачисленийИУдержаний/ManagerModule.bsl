...
Функция РасчетныйЛисток(ФизическиеЛица, Организация, МесяцФормированияОтчета, ОтчетРасчетныйЛисток = Неопределено) Экспорт
	...
	Возврат ДанныеРасчетныхЛистков(ФизическиеЛица, Организация, МесяцФормированияОтчета, ОтчетРасчетныйЛисток).ДокументРезультат;
	
КонецФункции

Функция ДанныеРасчетныхЛистков(ФизическиеЛица, Организация, МесяцФормированияОтчета, ОтчетРасчетныйЛисток = Неопределено) Экспорт
