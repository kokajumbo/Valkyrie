...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2014_1(Данные, УникальныйИдентификатор)
	...
	ИначеЕсли (СтрДлина(СокрЛП(Титульный.П_ОГРН)) <> 13 И СтрДлина(СокрЛП(Титульный.П_ОГРН)) <> 0) Или (Не УведомлениеОСпецрежимахНалогообложения.СтрокаСодержитТолькоЦифры(Титульный.П_ОГРН)) Тогда 
