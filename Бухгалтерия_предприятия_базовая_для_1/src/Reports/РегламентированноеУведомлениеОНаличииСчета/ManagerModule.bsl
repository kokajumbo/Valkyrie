...
Функция ПолучитьФормуПоУмолчанию() Экспорт 
	Возврат "Отчет.РегламентированноеУведомлениеОНаличииСчета.Форма.Форма2017_1";
КонецФункции
...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Форма уведомления о наличии счета в соответствии с приказом ФНС России от 28.08.2018 N ММВ-7-14/507@";
