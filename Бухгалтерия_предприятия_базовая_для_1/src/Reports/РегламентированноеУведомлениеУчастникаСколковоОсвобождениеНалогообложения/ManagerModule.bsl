...
Функция ПолучитьФормуПоУмолчанию() Экспорт 
	Возврат "Отчет.РегламентированноеУведомлениеУчастникаСколковоОсвобождениеНалогообложения.Форма.Форма2017_1";
КонецФункции
...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Форму уведомления участника Сколково в соответствии с приказом Минфина России от 30.12.2010 № 196н";
