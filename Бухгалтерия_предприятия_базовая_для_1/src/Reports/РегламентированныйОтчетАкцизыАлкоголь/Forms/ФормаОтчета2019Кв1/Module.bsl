...
Процедура СформироватьСлужебныеДанные()
	...
	Если Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2021 Тогда
		...
		СтавкиАкцизов.Вставить("111", 115);
		СтавкиАкцизов.Вставить("121", 115);
		СтавкиАкцизов.Вставить("130", 115);
		СтавкиАкцизов.Вставить("140", 115);
		СтавкиАкцизов.Вставить("150", 115);
		СтавкиАкцизов.Вставить("160", 115);
		СтавкиАкцизов.Вставить("161", 115);
		СтавкиАкцизов.Вставить("162", 115);
		СтавкиАкцизов.Вставить("163", 115);
		СтавкиАкцизов.Вставить("164", 115);
		СтавкиАкцизов.Вставить("165", 115);
		СтавкиАкцизов.Вставить("170", 115);
		СтавкиАкцизов.Вставить("224", 566);
		СтавкиАкцизов.Вставить("231", 452);
		СтавкиАкцизов.Вставить("232", 23);
		СтавкиАкцизов.Вставить("271", 38);
		СтавкиАкцизов.Вставить("272", 15);
		СтавкиАкцизов.Вставить("284", 20);
		СтавкиАкцизов.Вставить("285", 6);
		СтавкиАкцизов.Вставить("291", 0);
		СтавкиАкцизов.Вставить("292", 0);
		СтавкиАкцизов.Вставить("293", 452);
	...
	ИначеЕсли Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) = 2020 Тогда
		...
		СтавкиАкцизов.Вставить("111", 111);
		СтавкиАкцизов.Вставить("121", 111);
		СтавкиАкцизов.Вставить("130", 111);
		СтавкиАкцизов.Вставить("140", 111);
		СтавкиАкцизов.Вставить("150", 111);
		СтавкиАкцизов.Вставить("160", 111);
		СтавкиАкцизов.Вставить("161", 111);
		СтавкиАкцизов.Вставить("162", 111);
		СтавкиАкцизов.Вставить("163", 111);
		СтавкиАкцизов.Вставить("164", 111);
		СтавкиАкцизов.Вставить("165", 111);
		СтавкиАкцизов.Вставить("170", 111);
		СтавкиАкцизов.Вставить("224", 544);
		СтавкиАкцизов.Вставить("231", 435);
		СтавкиАкцизов.Вставить("232", 22);
		СтавкиАкцизов.Вставить("271", 37);
		СтавкиАкцизов.Вставить("272", 14);
		СтавкиАкцизов.Вставить("284", 19);
		СтавкиАкцизов.Вставить("285", 5);
		СтавкиАкцизов.Вставить("291", 0);
		СтавкиАкцизов.Вставить("292", 0);
		СтавкиАкцизов.Вставить("293", 435);
		СтавкиАкцизов.Вставить("310", 0);
