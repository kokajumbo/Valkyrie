		...
		Если Область.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Строки Тогда
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					ИначеЕсли СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20190701' И КодПоказателя = "1011446"
						И (Область.Имя = "КодыОпераций_Раздел4" ИЛИ Область.Имя = "КодыОпераций_Раздел5"
						ИЛИ Область.Имя = "КодыОпераций_Раздел6") Тогда
