...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.РедакцияФормы      = "от 30.09.2015 № ММВ-7-15/427.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма2015Кв4 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "1155114", '2015-09-30', "ММВ-7-15/427", "ФормаОтчета2015Кв4");
