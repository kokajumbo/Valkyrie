...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П002000100102", 250, , "Выбор продукции"        , КоллекцияСписковВыбора["СправочникОКПД"]);
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П002000100200", 250, ,                          , КоллекцияСписковВыбора["СправочникПриложениеДляВводаОКПД"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П002000100201", 250, , "Выбор продукции"        , КоллекцияСписковВыбора["СправочникОКПД"]);
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П002000100202", 250, , "Выбор продукции"        , КоллекцияСписковВыбора["СправочникОКПД"]);
КонецПроцедуры
...
Процедура ВвестиПоказательЗавершение(РезультатВыбора, ДополнительныеПараметры) Экспорт
	...
	О1_1 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы1 + "01_" + НомерСтроки];
	О1_2 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы1 + "02_" + НомерСтроки];
	О1_3 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы1 + "03_" + НомерСтроки];
	О1_4 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы1 + "04_" + НомерСтроки];
	
	О2_1 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "01_" + НомерСтроки];
	О2_2 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "02_" + НомерСтроки];
	О2_3 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "03_" + НомерСтроки];
	О2_4 = ТабличныйДокумент.Области[СтруктураРеквизитовФормы.мИдГруппы2 + "04_" + НомерСтроки];
	...
	Если СтрНайти(Область.Имя, СтруктураРеквизитовФормы.мИдГруппы1) > 0
		...
		Если Сред(Область.Имя, 12, 2) = "01" Или Сред(Область.Имя, 12, 2) = "02" Тогда
			...
			О1_1.Значение = ?(ЗначениеЗаполнено(ВыборКод), ВыборНазвание, "");
			О1_2.Значение = ВыборКод;
			О2_1.Значение = ?(ЗначениеЗаполнено(ВыборКод), ВыборНазвание, "");
			О2_2.Значение = ВыборКод;
		...
		ИначеЕсли Сред(Область.Имя, 12, 2) = "03" Или Сред(Область.Имя, 12, 2) = "04" Тогда
			О1_3.Значение = ?(ЗначениеЗаполнено(РезультатВыбора["Код"]), РезультатВыбора["Название"], "");
			О1_4.Значение = РезультатВыбора["Код"];
			О2_3.Значение = ?(ЗначениеЗаполнено(РезультатВыбора["Код"]), РезультатВыбора["Название"], "");
			О2_4.Значение = РезультатВыбора["Код"];
		КонецЕсли;
