	...
	Для каждого ПолеВыбраннойГруппировки Из ПараметрыОтчета.Группировка Цикл
		Если ПолеВыбраннойГруппировки.Использование Тогда
			...
			Если КоличествоГруппировок = 0 Тогда
				ГруппировкаТС = ПараметрыОтчета.Группировка.Найти("ОсновноеСредство", "Поле");
				Если ГруппировкаТС = Неопределено ИЛИ НЕ ГруппировкаТС.Использование Тогда
					Структура.Имя = "ТранспортныйНалогБезТС";
				Иначе
